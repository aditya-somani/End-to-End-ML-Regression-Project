...
def test_tune_saves_best_model(tmp_path):
    ...
    tracking_dir = tmp_path / "mlruns" # for MLflow tracking
    tracking_uri_fixed = Path(tracking_dir).as_uri()
